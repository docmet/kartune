...
from app.schemas.equipment import (
    KartCreate, KartUpdate, KartResponse,
    EngineCreate, EngineUpdate, EngineResponse
)
...
def list_karts(
    ...
    karts = db.query(Kart).filter(
        Kart.team_id == current_user.team_id
...
def list_engines(
    ...
    engines = db.query(Engine).filter(
        Engine.team_id == current_user.team_id
    ).offset(skip).limit(limit).all()
    return engines
