...
from app.schemas.session import SessionCreate, SessionUpdate, SessionResponse, TelemetryAnalysis
...
def list_sessions(
    ...
    query = db.query(RacingSession).filter(
        RacingSession.team_id == current_user.team_id
    )
